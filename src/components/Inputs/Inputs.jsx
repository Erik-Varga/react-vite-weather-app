  ...
  return (
    <div className='flex flex-row justify-center items-center my-6'>
      <div className='flex flex-row w-full justify-center items-center space-x-4 m-2 p-2'>
        <input type="text" className='w-full text-md font-light capitalize p-2 focus:outline-none placeholder:lowercase rounded shadow-lg' placeholder='Search for city ...' />
